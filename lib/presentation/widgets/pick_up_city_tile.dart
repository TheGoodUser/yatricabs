...
class PickUpCityTile extends ConsumerStatefulWidget {
  const PickUpCityTile({super.key});

  @override
  ConsumerState<PickUpCityTile> createState() => _PickUpCityTileState();
}

class _PickUpCityTileState extends ConsumerState<PickUpCityTile> {
  ...
  final String _focusId = "pickup_search_region";
